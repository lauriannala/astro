...
import MainComponent from '../components/Main.astro';
...
Functional programming, efficient system development, improving workflows and having fun with the code.

What I enjoy:
* Reading books about software, horror, fantasy, religion, philosophy, mysticism and wisdom
* Listening, composing and playing great music
...
I'm experienced with multiple programming languages, such as elixir/erlang/otp, java, c#, and typescript.
